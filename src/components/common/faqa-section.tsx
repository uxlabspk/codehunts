...
const FAQ: React.FC<FAQProps> = ({ question, answer }) => (
    <div className="faq-item bg-gray-50 p-6 rounded-2xl border border-gray-100 transition-all duration-300 ">
        <h3 className="text-xl font-bold mb-3 text-gray-800">{question}</h3>
